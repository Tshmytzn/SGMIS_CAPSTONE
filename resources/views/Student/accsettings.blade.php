...
@include('Admin.components.header', ['title' => 'Account Settings'])
...
<body>
    ...
    <div class="page">
        ...
        <div class="page-wrapper">
                            ...
                            <div class="col-3 d-none d-md-block border-end">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="my-account-tab" data-bs-toggle="pill"
                                                href="#my-account">
                                                <h3>My Account</h3>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="administrators-tab" data-bs-toggle="pill"
                                                href="#administrators">
                                                <h3>Primary Admins</h3>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="studentadmins-tab" data-bs-toggle="pill"
                                                href="#studentadmins">
                                            ...
                                            <div class="col d-flex flex-column">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-auto"><span class="avatar avatar-xl"><img
                                                                src="dept_image/{{ $adminAcc->admin_pic }}"
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-md">
                                                            ...
                                                            <input type="text" class="form-control" name="adminname"
                                                                id="adminname" value="{{ $adminAcc->admin_name }}">
                                                        </div>
                                                        <div class="col-md">
                                                            <div class="form-label">Student ID</div>
                                                            <input type="text" class="form-control"
                                                                name="adminschoolid" id="adminschoolid"
                                                                value="{{ $adminAcc->admin_school_id }}">
                                                        </div>
                                                    </div>
                                                </form>
                                  ...
                                  &nbsp; Demote
                                        ...
                                        <div class="tab-pane fade" id="studentadmins">
                                            <div class="d-flex align-items-center justify-content-end mb-3">
                                                ...
                                                <button class="btn btn-primary me-3" data-bs-toggle="modal"
                                                    data-bs-target="#addstudentadmin"
                                                    onclick="GetAllStudentData()">Add New Student Admin</button>
                                            </div>
            ...
            {{-- Modal --}}
            <div class="modal modal-blur fade" id="updatepassword" tabindex="-1" role="dialog"
                aria-hidden="true">
                            ...
                            <div class="w-100">
                                <div class="row">
                                    ...
                                    <div class="col"><button type="button" class="btn btn-success w-100"
                                            data-bs-dismiss="modal" onclick="ChangeAdminPic()">
                                            Save Changes
                                        </button></div>
                                </div>
                                </form>
