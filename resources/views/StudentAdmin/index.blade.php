...
@include('StudentAdmin.components.header', ['title' => 'Admin Dashboard'])
...
<body>
    ...
    <div class="page">
        @include('StudentAdmin.components.nav', ['active' => 'Admin Dashboard'])
    ...
    @include('StudentAdmin.components.dashboardscripts')
